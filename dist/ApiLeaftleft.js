...
let selectionMode = null; // Mode de sélection (départ/arrivée)
let departureCountryData = null; // Données du pays de départ
let arrivalCountryData = null; // Données du pays d'arrivée
...
function calculateDistance() {
    ...
    if (distanceKmInput)
        distanceKmInput.value = `${Math.round(realDistance)}`; // Met à jour le champ du formulaire
    let estimatedTime = "";
    let estimatedCost = "";
