    ...
    <div class="container mx-auto px-6 py-4">
        <div class="flex items-center justify-between">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="/creation-cargaison" class="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium">Créer Cargaison</a>
                ...
                <a href="/logout" class="text-gray-300 hover:text-cyan-400 transition-colors duration-300 font-medium bg-red-500 border border-red-600 rounded-lg p-2 inline-flex items-center justify-center">
